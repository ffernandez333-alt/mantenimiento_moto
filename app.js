...
const correctedComponentImportKey = bikeStorageKey('componentSpreadsheetImport20260917');
if (!localStorage.getItem(correctedComponentImportKey)) {
  ...
  localStorage.setItem(bikeStorageKey('componentEventsBackup20260917'), JSON.stringify(oldComponentEvents));
