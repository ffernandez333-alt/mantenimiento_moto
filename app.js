...
const correctedComponentImportKey = bikeStorageKey('componentSpreadsheetImport20260917b');
if (!localStorage.getItem(correctedComponentImportKey)) {
  ...
  localStorage.setItem(bikeStorageKey('componentEventsBackup20260917b'), JSON.stringify(oldComponentEvents));
...
if (!localStorage.getItem(spreadsheetComponentImportKey)) {
  setTimeout(() => {
